...
ps=Overlay3D165.ps
# Step-4. Add contour
gmt grdcontour geoid.egm96.grd -JM3.5i -R140/170/40/60\
    -p165/30 -C1 -A5 -Gd3c -Wthinnest,dimgray -Y3c\
...
# Step-6. Add 3D
grdview kkt_relief.nc -J -R -JZ2i -CrainbowKKT.cpt\
    -p165/30 -Qsm -N-7500+glightgray\
...
0.0 10.0 Composite overlay  of the 3D topographic mesh model on top of the 2D geoid contour plot
