#!/bin/sh
# Purpose: 3D grid, 205/45 azimuth, from GEBCO (here: Lebanon)
...
# Add 3D
gmt grdview lb_relief.nc -JM10c -R34.7/36.7/32.8/34.8 -JZ3.5c -Cmyocean.cpt \
...
EOF
gmt pstext -R -J -N -O -K \
-F+jTL+f9p,25,whitesmoke+jLB+a-295 >> $ps << EOF
